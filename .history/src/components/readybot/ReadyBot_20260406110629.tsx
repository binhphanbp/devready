      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 sm:inset-auto sm:bottom-6 sm:right-6 z-50 sm:w-[460px] sm:max-h-[640px] flex flex-col sm:rounded-2xl border-0 sm:border border-border/50 bg-card shadow-2xl overflow-hidden"
          >
            {/* Header */}
            ...
            <div
              ref={scrollRef}
              className="flex-1 overflow-y-auto px-4 py-4 space-y-4 min-h-0 sm:min-h-[360px] sm:max-h-[460px]"
            >
              {messages.length === 0 ? (
