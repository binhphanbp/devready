      ...
      <AnimatePresence>
        {open && !expanded && (
          <motion.div
            ...
            className="fixed inset-0 sm:inset-auto sm:bottom-6 sm:right-6 z-50 sm:w-[420px] sm:h-[580px] flex flex-col sm:rounded-2xl border-0 sm:border border-border/50 bg-card shadow-2xl overflow-hidden"
          >
            {/* Header */}
