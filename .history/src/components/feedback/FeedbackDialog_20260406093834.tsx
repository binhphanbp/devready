            ...
            >
              ...
              <div className="relative">
                ...
                >
                  ...
                  >
                    <CheckCircle2 className="h-9 w-9 text-emerald-400" strokeWidth={1.8} />
                  </motion.div>
                </motion.div>
              </div>
              ...
              <motion.div
                ...
                className="space-y-3"
              >
                <h3 className="text-2xl font-bold tracking-tight">Cảm ơn bạn đã góp ý!</h3>
                <p className="text-sm text-muted-foreground leading-relaxed max-w-xs mx-auto">
                  Phản hồi của bạn rất có giá trị với chúng tôi.
                </p>
                <p className="text-sm text-muted-foreground leading-relaxed max-w-xs mx-auto">
                  <span className="font-semibold text-foreground">Đội ngũ DevReady</span> sẽ xem xét
                  và không ngừng cải thiện nền tảng trong thời gian sớm nhất.
                </p>
              </motion.div>
