...
const feedbackTypes = [
  {
    ...
    activeClass:
      'border-red-500/60 bg-red-500/20 text-red-400 ring-1 ring-red-500/30',
  },
  {
    value: 'feature',
    ...
    activeClass:
      'border-violet-500/60 bg-violet-500/20 text-violet-400 ring-1 ring-violet-500/30',
  },
  {
    value: 'improvement',
    label: 'Cải thiện',
    ...
    activeClass:
      'border-blue-500/60 bg-blue-500/20 text-blue-400 ring-1 ring-blue-500/30',
  },
  {
    value: 'content',
    label: 'Nội dung',
    ...
    activeClass:
      'border-emerald-500/60 bg-emerald-500/20 text-emerald-400 ring-1 ring-emerald-500/30',
  },
  {
    value: 'other',
    label: 'Khác',
    ...
    icon: HelpCircle,
    className:
      'border-zinc-500/30 bg-zinc-500/10 text-zinc-400 hover:border-zinc-500/60 hover:bg-zinc-500/20',
    activeClass:
      'border-zinc-500/60 bg-zinc-500/20 text-zinc-400 ring-1 ring-zinc-500/30',
  },
] as const;
        ...
        <AnimatePresence mode="wait">
          {success ? (
            <motion.div
              ...
              className="flex flex-col items-center gap-6 px-8 py-12 text-center min-w-0"
            >
              {/* Animated icon */}
              <div className="relative">
                <motion.div
                  ...
                  className="flex h-24 w-24 items-center justify-center rounded-full bg-emerald-500/10 ring-8 ring-emerald-500/10"
                >
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    ...
                    className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-500/20 ring-4 ring-emerald-500/25"
                  >
                    <CheckCircle2
              ...
              >
                ...
                <p className="text-sm text-muted-foreground leading-relaxed max-w-xs mx-auto">
                  ...
                  sẽ xem xét và không ngừng cải thiện nền tảng trong thời gian
                  sớm nhất.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="w-16 h-px bg-border/60"
              />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      Giúp DevReady ngày càng tốt hơn
                    </p>
                  </div>
                </div>
              </DialogHeader>
              ...
              <div className="overflow-y-auto overscroll-contain px-6 py-5 space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    rows={4}
                    className={cn(
                      'w-full resize-none wrap-break-word',
                      contentError &&
                        'border-red-500/60 focus-visible:ring-red-500/20',
                    )}
                  />
