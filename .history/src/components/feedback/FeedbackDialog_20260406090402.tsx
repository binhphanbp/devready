    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <button
          title="Góp ý & Đề xuất"
          className={cn(
            'group flex w-full items-center gap-3 rounded-xl px-3 py-3 lg:py-2.5 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted/40 transition-all duration-200 min-h-[44px]',
          )}
        >
          <Lightbulb className="h-[18px] w-[18px] shrink-0 transition-colors group-hover:text-foreground" />
              ...
              <div className="px-6 py-5 space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className={cn(titleError && 'border-red-500/60 focus-visible:ring-red-500/20')}
                  />
                  {titleError && (
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    rows={4}
                    className={cn('resize-none', contentError && 'border-red-500/60 focus-visible:ring-red-500/20')}
                  />
                  {contentError && (
