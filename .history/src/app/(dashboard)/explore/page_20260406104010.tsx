...
// Lazy-load QuestionDetail — contains ReactMarkdown + rehype-highlight + highlight.js (~200KB)
// Only needed when user clicks a question, not on initial list render
const QuestionDetail = dynamic(
  () => import('@/components/explore/QuestionDetail').then((m) => ({ default: m.QuestionDetail })),
  { loading: () => (
...
// Lean type used for list rendering — no heavy text fields
...
// Full type used when a question is opened
