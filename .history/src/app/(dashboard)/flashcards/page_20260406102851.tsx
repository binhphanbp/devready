...
const CreateDeckDialog = dynamic(() => import('@/components/flashcards/CreateDeckDialog').then(m => ({ default: m.CreateDeckDialog })));
const EditDeckDialog = dynamic(() => import('@/components/flashcards/EditDeckDialog').then(m => ({ default: m.EditDeckDialog })));
const AddCardDialog = dynamic(() => import('@/components/flashcards/AddCardDialog').then(m => ({ default: m.AddCardDialog })));
const StudyMode = dynamic(() => import('@/components/flashcards/StudyMode').then(m => ({ default: m.StudyMode })));
      ...
      <div className="space-y-4 sm:space-y-6 pt-6 sm:pt-8 lg:pt-0">
        ...
        {deckToEdit && (
          <EditDeckDialog
            ...
            deck={deckToEdit}
            onUpdated={(updated) => {
              setDecks(decks.map((d) => d.id === updated.id ? { ...d, ...updated } : d));
              setDeckToEdit(null);
