...
export function OnboardingForm({ userId }: { userId: string }) {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-8 overflow-hidden">
      ...
      <div className="absolute -top-[30%] -left-[20%] h-150 w-150 rounded-full bg-primary/5 blur-[120px]" />
      <div className="absolute -bottom-[20%] -right-[20%] h-125 w-125 rounded-full bg-blue-500/5 blur-[100px]" />
      ...
      <div className="relative w-full max-w-lg">
        ...
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-[#0066FF] to-[#00AAFF] shadow-md shadow-[#0066FF]/20">
              ...
              <div key={step.id} className="flex items-center gap-2">
                <div
                  className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold transition-all duration-300 ${
                    currentStep >= step.id
                      ? 'bg-linear-to-br from-[#0066FF] to-[#00AAFF] text-white shadow-md shadow-[#0066FF]/20'
          ...
          <CardContent className="p-6 sm:p-8">
            ...
            {currentStep === 1 && (
              ...
              >
                ...
                <div className="text-center">
                  <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-blue-500/20 to-cyan-500/20 mb-4">
            ...
            {currentStep === 2 && (
              ...
              >
                {/* Header */}
                <div className="text-center">
                  <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-purple-500/20 to-pink-500/20 mb-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                          DevReady sẽ ưu tiên hiển thị câu hỏi phỏng vấn phù hợp
                          với vị trí và chuyên ngành của bạn, giúp bạn luyện tập
                          hiệu quả hơn.
                        </p>
                      </div>
                    </div>
            ...
            {currentStep === 3 && (
              ...
              >
                {/* Header */}
                <div className="text-center">
                  <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-emerald-500/20 to-teal-500/20 mb-4">
                  ...
                  <SummaryRow
                    ...
                    value={
                      major === 'other'
                        ...
                        : MAJOR_OPTIONS.find((m) => m.value === major)?.label ||
                          'Chưa chọn'
                    }
                  />
                  <SummaryRow
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="glow-blue bg-linear-to-r from-[#0066FF] to-[#0055DD] text-white border-0 min-w-35"
                  >
                    {loading ? (
